// ======================================================================
// Robotka_1.v generated from TopDesign.cysch
// 05/30/2023 at 11:00
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=true, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=RIGHT_MOT_PWM, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=RIGHT_MOT_PWM, CY_INSTANCE_SHORT_NAME=RIGHT_MOT_PWM, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=RIGHT_MOT_PWM, )
module PWM_v3_30_1 (
    reset,
    clock,
    tc,
...
module ADC_SAR_v3_10_2 (
	...
	cy_psoc3_pins_v1_10
		#(.id("be7d5807-47f3-415d-90f8-8c5759e9e1f0/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module CharLCD_v2_20_3 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("420ef4b8-68f0-4297-b8e7-fded3b3208de/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    PWM_v3_30_0 LEFT_MOT_PWM (
        ...
        .ph1(Net_439),
        .ph2(Net_440));
    defparam LEFT_MOT_PWM.Resolution = 8;
	...
	wire [0:0] tmpOE__LEFT_MOT_CNTRL_net;
	wire [0:0] tmpFB_0__LEFT_MOT_CNTRL_net;
	wire [0:0] tmpIO_0__LEFT_MOT_CNTRL_net;
	wire [0:0] tmpINTERRUPT_0__LEFT_MOT_CNTRL_net;
	electrical [0:0] tmpSIOVREF__LEFT_MOT_CNTRL_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		LEFT_MOT_CNTRL
		 (.oe(tmpOE__LEFT_MOT_CNTRL_net),
		  .y({Net_74}),
		  .fb({tmpFB_0__LEFT_MOT_CNTRL_net[0:0]}),
		  .io({tmpIO_0__LEFT_MOT_CNTRL_net[0:0]}),
		  .siovref(tmpSIOVREF__LEFT_MOT_CNTRL_net),
		  .interrupt({tmpINTERRUPT_0__LEFT_MOT_CNTRL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LEFT_MOT_CNTRL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RIGHT_MOT_CNTRL_net;
	wire [0:0] tmpFB_0__RIGHT_MOT_CNTRL_net;
	wire [0:0] tmpIO_0__RIGHT_MOT_CNTRL_net;
	wire [0:0] tmpINTERRUPT_0__RIGHT_MOT_CNTRL_net;
	electrical [0:0] tmpSIOVREF__RIGHT_MOT_CNTRL_net;

	cy_psoc3_pins_v1_10
		#(.id("4612812b-3e28-41f6-90ea-23010163b10f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		RIGHT_MOT_CNTRL
		 (.oe(tmpOE__RIGHT_MOT_CNTRL_net),
		  .y({Net_88}),
		  .fb({tmpFB_0__RIGHT_MOT_CNTRL_net[0:0]}),
		  .io({tmpIO_0__RIGHT_MOT_CNTRL_net[0:0]}),
		  .siovref(tmpSIOVREF__RIGHT_MOT_CNTRL_net),
		  .interrupt({tmpINTERRUPT_0__RIGHT_MOT_CNTRL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RIGHT_MOT_CNTRL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("b87deb11-ae96-4407-95a7-6e7a4462e2b3"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("6c24e425-a087-404f-9409-ca02aadc67a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1d333a08-677e-40be-b4c0-0c7e3f989523"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b768aa7e-0f87-4108-afed-53e18da347ad"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_1 RIGHT_MOT_PWM (
        ...
        .ph1(Net_554),
        .ph2(Net_555));
    defparam RIGHT_MOT_PWM.Resolution = 8;

    assign Net_507 = 1'h0;

    CyControlReg_v1_80 Reg_PWM (
        .control_1(Net_569),
        .control_2(Net_559),
        .control_3(Net_560),
        .control_0(Net_434),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Reg_PWM.Bit0Mode = 0;
    defparam Reg_PWM.Bit1Mode = 0;
    defparam Reg_PWM.Bit2Mode = 0;
    defparam Reg_PWM.Bit3Mode = 0;
    defparam Reg_PWM.Bit4Mode = 0;
    defparam Reg_PWM.Bit5Mode = 0;
    defparam Reg_PWM.Bit6Mode = 0;
    defparam Reg_PWM.Bit7Mode = 0;
    defparam Reg_PWM.BitValue = 0;
    defparam Reg_PWM.BusDisplay = 0;
    defparam Reg_PWM.ExtrReset = 0;
    defparam Reg_PWM.NumOutputs = 2;
