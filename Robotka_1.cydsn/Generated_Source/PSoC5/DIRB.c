...
{
    uint8 staticBits = (DIRB_DR & (uint8)(~DIRB_MASK));
    DIRB_DR = staticBits | ((uint8)(value << DIRB_SHIFT) & DIRB_MASK);
}
...
{
	CyPins_SetPinDriveMode(DIRB_0, mode);
}
...
{
    return (DIRB_PS & DIRB_MASK) >> DIRB_SHIFT;
}
...
{
    return (DIRB_DR & DIRB_MASK) >> DIRB_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(DIRB_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & DIRB_0_INTR) != 0u) 
		{ 
			 DIRB_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (DIRB_INTSTAT & DIRB_MASK) >> DIRB_SHIFT;
    }
